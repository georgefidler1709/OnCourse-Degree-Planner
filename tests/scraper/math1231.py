...
<head>
			<meta name="viewport" content="width=device-width, initial-scale=1.0">
	  				<meta charset="utf-8">
<title>Handbook - Course - Mathematics 1B - MATH1231</title>

<meta name="viewport" content="width=device-width, initial-scale=1.0">
	
	  <meta name="description" content="Mathematics 1B">

      <meta name="keywords" content="mathematics">
  
  <meta name="author" content="School of Mathematics & Statistics">
...
<!-- Courseloop-ui / handbook includes -->
	...
	<!-- Live -->
	<link href="https://courseloop-ui.s3.amazonaws.com/handbook/unsw/unswPRODUCTION/assets/all.css?v=2019-11-11-22-18" rel="stylesheet">
	<script src="https://courseloop-ui.s3.amazonaws.com/handbook/unsw/unswPRODUCTION/assets/all.js?v=2019-11-11-22-18"></script>
...
<nav class="breadcrumbs" id="breadcrumbs-nav" role="navigation" aria-label="Breadcrumbs Navigation">
  ...
  <ul>
    <li><a href="/">Home</a></li>
      ...
      <li class="crumb truncate"><span title="MATH1231 - Mathematics 1B" tabindex="0">MATH1231 - Mathematics 1B</span></li>
 ...
 document.addEventListener('DOMContentLoaded', function() {
  ...
  <div class="a-wrapper o-ai-overview-inner">
    ...
    <span
      ...
      <h1 class="o-ai-overview__h1"><span data-hbui="module-title">Mathematics 1B</span></h1>
    </div>

    <div class="m-ai-overview-details">
      <div class="m-ai-overview-details__cell code p-left-0"><strong>MATH1231</strong></div>
  ...
  <div class="a-row a-row-equal-height o-attributes-table">
      ...
      <div class="o-attributes-table-item ">
        <strong tabindex="0">Faculty</strong>
                      <a href="http://www.science.unsw.edu.au" target="_blank">Faculty of Science</a>
                </div>
    </div>
            <div class="a-column a-column-df-12 a-column-md-6 a-column-sm-12">
      <div class="o-attributes-table-item ">
        <strong tabindex="0">School</strong>
                      <a href="http://www.maths.unsw.edu.au/" target="_blank">School of Mathematics & Statistics</a>
                </div>
    </div>
            <div class="a-column a-column-df-12 a-column-md-6 a-column-sm-12">
      <div class="o-attributes-table-item ">
      ...
      <div class="o-attributes-table-item ">
        <strong tabindex="0">Campus</strong>
            ...
            <div class="a-column a-column-df-12 a-column-md-6 a-column-sm-12">
      <div class="o-attributes-table-item ">
        <strong tabindex="0">Delivery Mode</strong>
                                  <p tabindex="0" class="">Partially online</p>
                </div>
    </div>
            <div class="a-column a-column-df-12 a-column-md-6 a-column-sm-12">
      <div class="o-attributes-table-item ">
        <strong tabindex="0">Indicative contact hours</strong>
                                  <p tabindex="0" class="">6</p>
                </div>
    </div>
      ...
      <div class="o-attributes-table-item no-border">
        <strong tabindex="0">Timetable</strong>
                                  <a href="http://timetable.unsw.edu.au/2020/MATH1231.html" target="_blank">Visit timetable website for details</a>
                </div>
    </div>
        </div>
</div>      </div>
      ...
      <div data-hbui="readmore" tabindex="0" id="readMoreSubjectConditions" class="m-read-more-toggle">
        <div data-hbui="readmore__toggle-text" class="a-card-text m-toggle-text has-focus">
          <div>Prerequisite: MATH1131 or DPST1013 or MATH1141</div>
        </div>
        <div class="a-card-footer m-read-more-footer">
    ...
    <a href="/undergraduate/courses/2020/DPST1014/
...
" target="_blank" class="m-single-course with-icon muted  ">
      ...
      <div class="m-single-course-top-row">
        <span class="align-left">DPST1014</span>
                  <span>6 UOC</span>
              </div>
      <div class="m-single-course-bottom-row">
        <p class="text-color-blue-400 no-margin">Mathematics 1B</p>
      </div>
    </a>
  </div>
      </div>
...
" target="_blank" class="m-single-course with-icon muted  ">
      ...
      <div class="m-single-course-bottom-row">
        <p class="text-color-blue-400 no-margin">Mathematics 1B</p>
                ...
                <div class="m-single-course-wrapper">
    <a href="/undergraduate/courses/2020/MATH1251/

" target="_blank" class="m-single-course with-icon muted  ">
      <span class="a-icon" aria-hidden="true">arrow_forward</span>
      <div class="m-single-course-top-row">
        <span class="align-left">MATH1251</span>
                  <span>6 UOC</span>
              </div>
      <div class="m-single-course-bottom-row">
        <p class="text-color-blue-400 no-margin">Mathematics for Actuarial Studies and Finance 1B</p>
      </div>
    </a>
  </div>
                <div class="m-single-course-wrapper">
...
" target="_blank" class="m-single-course with-icon muted pointer-events-none a-link-disabled ">
      <span class="a-icon" aria-hidden="true">arrow_forward</span>
      <div class="m-single-course-top-row">
        <span class="align-left">MATH1021</span>
                  <span>6 UOC</span>
              </div>
      <div class="m-single-course-bottom-row">
        <p class="text-color-blue-400 no-margin">General Mathematics 1C</p>
      </div>
    </a>
  </div>
                <div class="m-single-course-wrapper">
    <a href="/undergraduate/courses/2020/MATH1241/

" target="_blank" class="m-single-course with-icon muted  ">
      <span class="a-icon" aria-hidden="true">arrow_forward</span>
      <div class="m-single-course-top-row">
        <span class="align-left">MATH1241</span>
                  <span>6 UOC</span>
              </div>
      <div class="m-single-course-bottom-row">
        <p class="text-color-blue-400 no-margin">Higher Mathematics 1B</p>
      </div>
    </a>
  </div>
      </div>
    ...
    <h3  tabindex="0">Course Outline</h3>
        ...
        <div class="m-button-group m-button-group--list">
              <a tabIndex="0" class="a-btn-secondary a-btn-secondary--with-icon" href="http://www.maths.unsw.edu.au/" target="_blank" aria-label="MATH1231 Course Outline">
          MATH1231 Course Outline
...
<br><br>Where a Commonwealth Supported Students fee is displayed, it does not guarantee such places are available. 
  ...
  <span aria-hidden="true" class="a-icon m-right-1 m-left-1" aria-label="Click enter to send a copy of MATH1231 - Mathematics 1B via email" style="opacity: .54">local_post_office</span>
  <a data-hbui="email_link" data-body="Hi! I found this page from UNSW that you might be interested in:" data-subject="UNSW link to Course: MATH1231 - Mathematics 1B">Share Link via Email</a>
</div>
        
<div class="m-bottom-1">
  <span aria-hidden="true" class="a-icon m-right-1 m-left-1" style="opacity: .54">get_app</span>
  <a target="_blank" href="https://itq9q5ny14.execute-api.ap-southeast-2.amazonaws.com/prod/pdf?url=https://www.handbook.unsw.edu.au/undergraduate/courses/2020/math1231" data-hbui="pdf_link">Download PDF</a>
</div>
    ...
    <div class="m-page-nav m-bottom-2" data-hbui="mobile-nav">
      ...
      <div data-gumshoe class="m-page-nav-list" role="list">
            ...
            <a data-scroll href="#subject-intro" tabindex="0">Overview</a>
                  ...
                  <div role="listitem">
            <a data-scroll href="#SubjectConditions" tabindex="0">Conditions for Enrolment</a>
          </div>
                  <div role="listitem">
